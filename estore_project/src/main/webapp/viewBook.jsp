...
<body>
<%
    //index页面带参数跳转的，参数是product的id值,拿到product
    int id=Integer.parseInt(request.getParameter("id"));
    SProductService sPservice=new SProductService();
    SProduct product=sPservice.selectProductById(id);
    ...
    <div class="header3">
        ...
        <div class="h3_right">
            ...
            <div class="tsc">
            <!-- 将书籍的product的id传给购物车页面  -->
            	<a href="shopCart.jsp?id=<%=id%>">去购物车结算</a>
    	...
    	<div class="cn5_top">
            ...
            <div class="cn5_top_y center01">
            	<div class="cn5topy_1">
                	...
                	<%
                	out.print("<img src='"+product.getImg()+"'/>");
                	out.print("<ul class='cn5topy_imglist'>");
                	out.print("<li><a href='#'><img src='"+product.getImg()+"'></a></li>");
                	out.print("<li class='current'><a href='#'><img src='"+product.getImg()+"'></a></li>");
                	out.print("<li><a href='#'><img src='"+product.getImg()+"'></a></li>");
                	out.print("<li><a href='#'><img src='"+product.getImg()+"'></a></li>");
                	out.print("<li><a href='#'><img src='"+product.getImg()+"'></a></li>");
                	out.print("</ul>");
                ...
                <div class="cn5topy_2">
                    ...
                    <div class="pro_buy">
                       ...
                       <div class="pro_addshop"> <a href="javascript:void(0)" onclick="addShopCart('<%=product.getName()%>')">加入购物车 </a></div>
                    </div>
              	...
              	<div class="c5_b2_right_1 box">
                        <div class="introduce_item">
                          <ul>
                            ...
                            <li>商品编号：<%=product.getPublishdate() %></li>
                    ...
                    <% 
                    out.print("<img class='intro_pic' src='"+product.getImg()+"'>");
                    %>
