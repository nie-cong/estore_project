		...
		<div class="row">
			<div style="float: left" class="line">
				...
				<div style="margin-left: 80px;">
					<img src="<%=product.getImg() %> " width='80' height='80'style="float: left">
					<span><%=product.getName() %></span>
				</div>
			</div>
			<div style="float: right" class="row_right">
				<div style="margin-right: 10px">￥<%=product.getPrice() %>元</div><!-- 单价 -->
				<div>
					<span class="jian">-</span>
					<span><input type="text" class="val" value="1" style="text-align: center"></span>
					<span class="sum">+</span>
				</div>
				<div class="price">￥<%=product.getPrice() %>元</div><!-- 小结 -->
				<div>
					<a href="">删除</a>
				</div>
			</div>
